[![Run App RyanArgo](https://github.com/rargo4/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/rargo4/GithubActions/actions/workflows/run-app.yaml)
